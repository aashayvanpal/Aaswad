...
// Refactor this code to make dynamic like single orders
...
const pdfGenerate = ({
  ...
  // doc.text(45, 165, `Mobile :  ${mobile}`);
  doc.text(45, 165, `Mobile :  9967111587`);
